...
internal sealed class JobEditorForm : MediaFluxForm
{
    ...
    public JobEditorForm(EncodeJob job)
    {
        ...
        _grid = new TableLayoutPanel { Dock = DockStyle.Fill, Padding = new Padding(12), ColumnCount = 2, RowCount = 7 };
