...
public sealed partial class SqliteLibraryCatalog : ILibraryMaintenanceCatalog
{
    ...
    private static LibraryMaintenanceRun ReadRun(SqliteDataReader r)=>new(r.GetInt64(0),r.GetInt64(1),(LibraryMaintenanceTrigger)r.GetInt32(2),(LibraryMaintenanceOutcome)r.GetInt32(3),r.GetString(4),FromUtcTicks(r.GetInt64(5)),r.IsDBNull(6)?null:FromUtcTicks(r.GetInt64(6)),r.GetInt64(7),r.GetInt64(8),r.GetInt64(9),r.GetInt64(10),r.GetInt64(11),r.GetInt64(12),r.GetInt64(13),r.GetInt64(14),r.GetString(15),(LibraryMaintenanceActions)r.GetInt32(16),(LibraryMaintenanceAnalysisMode)r.GetInt32(17),(LibraryMaintenanceConflictBehavior)r.GetInt32(18),r.GetInt32(19)!=0,r.IsDBNull(20)?null:FromUtcTicks(r.GetInt64(20)));
}
